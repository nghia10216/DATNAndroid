...
//    fun deleteData(@Query("id") id: String, @Query("hinhanh") hinhanh: String): Call<String>
    ...
    @GET("hoidap/{hoidap}")
    fun getHoiDap(@Header("Authorization") authHeader: String, @Path("hoidap") idUser: Int): Call<MutableList<HoiDap>>
    @FormUrlEncoded
    @POST("hoidap")
    fun postCauHoi(@Header("Authorization") authHeader: String,  @Field("CauHoi") cauhoi: String, @Field("CauTraLoi") cautraloi: String, @Field("idUser") idUser: Int): Call<HoiDap>
